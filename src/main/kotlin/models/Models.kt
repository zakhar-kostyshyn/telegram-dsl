...
// Getting updates
     ...
     * @property drop_pending_updates Pass <em>True</em> to drop all pending updates
     * */
    data class DeleteWebhookMethod(
        val drop_pending_updates: Boolean? = null,
    ) : TelegramMethod()
...
// Available services.methods
     ...
     * */
    data class ForwardMessageMethod(
        val chat_id: String,
     ...
     * @property reply_markup Additional interface options. A JSON-serialized object for an <a href="https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.telegram.org/bots#keyboards">custom reply keyboard</a>, instructions to remove reply keyboard or to force a reply from the user.
     * */
    data class SendAnimationMethod(
        val chat_id: String,
     ...
     * @property reply_markup Additional interface options. A JSON-serialized object for an <a href="https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.telegram.org/bots#keyboards">custom reply keyboard</a>, instructions to remove reply keyboard or to force a reply from the user.
     * */
    data class SendVideoNoteMethod(
        val chat_id: String,
     ...
     * @property allow_sending_without_reply Pass <em>True</em>, if the message should be sent even if the specified replied-to message is not found
     * */
    data class SendMediaGroupMethod(
        val chat_id: String,
     ...
     * */
    data class EditMessageLiveLocationMethod(
     ...
     * @property reply_markup A JSON-serialized object for a new <a href="https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.
     * */
    data class StopMessageLiveLocationMethod(
        val chat_id: String? = null,
        val message_id: Long? = null,
        val inline_message_id: String? = null,
        val reply_markup: InlineKeyboardMarkup? = null,
     ...
     * */
    data class SendChatActionMethod(
        val chat_id: String,
        val action: String,
    ) : TelegramMethod()
     ...
     * */
    data class GetUserProfilePhotosMethod(
        val user_id: Long,
        val offset: Long? = null,
        val limit: Long? = null,
    ) : TelegramMethod()
     ...
     * */
    data class BanChatMemberMethod(
        val chat_id: String,
        val user_id: Long,
     ...
     * */
    data class UnbanChatMemberMethod(
        val chat_id: String,
        val user_id: Long,
     ...
     * */
    data class RestrictChatMemberMethod(
        val chat_id: String,
        val user_id: Long,
     ...
     * */
    data class PromoteChatMemberMethod(
        val chat_id: String,
        val user_id: Long,
        val is_anonymous: Boolean? = null,
     ...
     * */
    data class SetChatAdministratorCustomTitleMethod(
        val chat_id: String,
        val user_id: Long,
     ...
     * */
    data class SetChatPermissionsMethod(
        val chat_id: String,
        val permissions: ChatPermissions,
    ) : TelegramMethod()
     ...
     * @property chat_id Unique identifier for the target chat or username of the target channel (in the format <code>@channelusername</code>)
     * */
    data class ExportChatInviteLinkMethod(
        val chat_id: String,
    ) : TelegramMethod()
     ...
     * */
    data class CreateChatInviteLinkMethod(
        val chat_id: String,
        val expire_date: Long? = null,
        val member_limit: Long? = null,
    ) : TelegramMethod()
     ...
     * @property member_limit Maximum number of users that can be members of the chat simultaneously after joining the chat via this invite link; 1-99999
     * */
    data class EditChatInviteLinkMethod(
        val chat_id: String,
        val invite_link: String,
        val expire_date: Long? = null,
        val member_limit: Long? = null,
     ...
     * */
    data class RevokeChatInviteLinkMethod(
        val chat_id: String,
        val invite_link: String,
    ) : TelegramMethod()
     ...
     * @property chat_id Unique identifier for the target chat or username of the target channel (in the format <code>@channelusername</code>)
     * */
    data class DeleteChatPhotoMethod(
        val chat_id: String,
    ) : TelegramMethod()
     ...
     * */
    data class SetChatDescriptionMethod(
        val chat_id: String,
        val description: String? = null,
    ) : TelegramMethod()
     ...
     * */
    data class PinChatMessageMethod(
        val chat_id: String,
        val message_id: Long,
        val disable_notification: Boolean? = null,
    ) : TelegramMethod()
     ...
     * */
    data class UnpinChatMessageMethod(
        val chat_id: String,
        val message_id: Long? = null,
    ) : TelegramMethod()
     ...
     * @property chat_id Unique identifier for the target chat or username of the target channel (in the format <code>@channelusername</code>)
     * */
    data class UnpinAllChatMessagesMethod(
        val chat_id: String,
    ) : TelegramMethod()
     ...
     * @property chat_id Unique identifier for the target chat or username of the target supergroup or channel (in the format <code>@channelusername</code>)
     * */
    data class GetChatAdministratorsMethod(
        val chat_id: String,
    ) : TelegramMethod()
     ...
     * @property chat_id Unique identifier for the target chat or username of the target supergroup or channel (in the format <code>@channelusername</code>)
     * */
    data class GetChatMemberCountMethod(
        val chat_id: String,
    ) : TelegramMethod()
     ...
     * @property user_id Unique identifier of the target user
     * */
    data class GetChatMemberMethod(
        val chat_id: String,
        val user_id: Long,
    ) : TelegramMethod()
     ...
     * */
    data class SetChatStickerSetMethod(
        val chat_id: String,
     ...
     * @property chat_id Unique identifier for the target chat or username of the target supergroup (in the format <code>@supergroupusername</code>)
     * */
    data class DeleteChatStickerSetMethod(
        val chat_id: String,
    ) : TelegramMethod()
     ...
     * */
    data class AnswerCallbackQueryMethod(
     ...
     * */
    data class SetMyCommandsMethod(
     ...
     * @property language_code A two-letter ISO 639-1 language code. If empty, commands will be applied to all users from the given scope, for whose language there are no dedicated commands
     * */
    data class DeleteMyCommandsMethod(
        val scope: BotCommandScope? = null,
        val language_code: String? = null,
    ) : TelegramMethod()
     ...
     * */
    data class GetMyCommandsMethod(
        val scope: BotCommandScope? = null,
        val language_code: String? = null,
    ) : TelegramMethod()
...
// Updating messages
     ...
     * */
    data class EditMessageTextMethod(
        val chat_id: String? = null,
        val message_id: Long? = null,
        val inline_message_id: String? = null,
        val text: String,
     ...
     * @property reply_markup A JSON-serialized object for an <a href="https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.
     * */
    data class EditMessageCaptionMethod(
        val chat_id: String? = null,
        val message_id: Long? = null,
        val inline_message_id: String? = null,
        val caption: String? = null,
     ...
     * @property reply_markup A JSON-serialized object for a new <a href="https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.
     * */
    data class EditMessageMediaMethod(
        val chat_id: String? = null,
        val message_id: Long? = null,
        val inline_message_id: String? = null,
     ...
     * @property reply_markup A JSON-serialized object for an <a href="https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.
     * */
    data class EditMessageReplyMarkupMethod(
        val chat_id: String? = null,
        val message_id: Long? = null,
        val inline_message_id: String? = null,
        val reply_markup: InlineKeyboardMarkup? = null,
     ...
     * */
    data class DeleteMessageMethod(
        val chat_id: String,
        val message_id: Long,
    ) : TelegramMethod()
...
// Stickers
     ...
     * */
    data class GetStickerSetMethod(
        val name: String,
    ) : TelegramMethod()

    /**
     * <p>Use this method to upload a .PNG file with a sticker for later use in <em>createNewStickerSet</em> and <em>addStickerToSet</em> services.methods (can be used multiple times). Returns the uploaded <a href="#file">File</a> on success.</p>
     *
     ...
     * */
    data class UploadStickerFileMethod(
        val user_id: Long,
        val png_sticker: Any,
    ) : TelegramMethod()
     ...
     * */
    data class CreateNewStickerSetMethod(
        val user_id: Long,
        val name: String,
        val title: String,
     ...
     * @property mask_position A JSON-serialized object for position where the mask should be placed on faces
     * */
    data class AddStickerToSetMethod(
        val user_id: Long,
        val name: String,
        val png_sticker: String? = null,
        val tgs_sticker: Any? = null,
     ...
     * */
    data class SetStickerPositionInSetMethod(
        val sticker: String,
        val position: Long,
    ) : TelegramMethod()
     ...
     * @property sticker File identifier of the sticker
     * */
    data class DeleteStickerFromSetMethod(
        val sticker: String,
    ) : TelegramMethod()
     ...
     * */
    data class SetStickerSetThumbMethod(
        val name: String,
        val user_id: Long,
        val thumb: String? = null,
    ) : TelegramMethod()
...
// Payments
     ...
     * */
    data class AnswerShippingQueryMethod(
     ...
     * */
    data class AnswerPreCheckoutQueryMethod(
...
// Telegram Passport
     ...
     * */
    data class SetPassportDataErrorsMethod(
        val user_id: Long,
...
// Games
     ...
     * @property inline_message_id Required if <em>chat_id</em> and <em>message_id</em> are not specified. Identifier of the inline message
     * */
    data class GetGameHighScoresMethod(
        val user_id: Long,
        val chat_id: Long? = null,
        val message_id: Long? = null,
        val inline_message_id: String? = null,
